...
export const CASE_SECTIONS = [
  {
    ...
    blocks: [
      ...
      { p: 'Because the owner works full-time in the café, the real question is not just "is this profitable" but whether the margin — on top of forgoing a market wage elsewhere — makes the move worth it. The Conservative base case seeds the model at £119k daytime + £62k aperitivo + £4k wine events ≈ £185k revenue against ~£131k costs. Every figure is live in the Model tab: change an assumption and the case re-answers itself.' },
      { ul: [
  ...
  },
  {
    ...
    blocks: [
      { p: 'The Conservative base case seeds the model at: 40 daytime covers × £8.50 × 350 days (£119k), aperitivo 4 nights × 52 weeks × 15 covers × £15 (£46.8k), and 12 wine events × 18 covers (£4k) — ~£169k revenue against ~£125k costs. The Mid and Optimistic scenarios raise daytime volume and evening uptake. All of it is editable and recomputed live in the Model tab, which supersedes the numbers in this prose.' },
